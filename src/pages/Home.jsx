...
export default function Home() {
  ...
  return (
    <div className="space-y-16">
      ...
      <section
        className="relative min-h-[520px] flex items-center justify-center rounded-3xl overflow-hidden -mt-4"
        style={{
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center text-center px-6 py-16 space-y-5">
          <h1 className="font-heading text-5xl md:text-7xl font-semibold tracking-tight text-white">
            Artistique Machine
          </h1>
          <p className="text-base md:text-lg text-white/80 max-w-xl">
            L'art de la décoration à Marrakech
          </p>
          <Link
            to="/products"
            className="rounded-full px-8 py-3 text-sm font-semibold text-white transition hover:opacity-90 mt-2"
            ...
            <div className="relative grid grid-cols-2 gap-3 p-4">
              <div className="space-y-3">
                <div className="overflow-hidden rounded-2xl bg-sable-200">
                  <img src={miroir8} alt="Miroir artisanal" className="aspect-square w-full object-cover" />
                </div>
                <div className="overflow-hidden rounded-2xl bg-sable-200">
                  <img src={product1} alt="Objet en cuir" className="aspect-square w-full object-cover" />
                </div>
              </div>
              <div className="space-y-3 pt-6">
                <div className="overflow-hidden rounded-2xl bg-sable-200">
                  <img src={product2} alt="Décoration murale" className="aspect-square w-full object-cover" />
                </div>
                <div className="overflow-hidden rounded-2xl bg-sable-200">
                  <img src={miroir1} alt="Design artistique" className="aspect-square w-full object-cover" />
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="space-y-6">
        <div className="flex flex-col gap-2 md:flex-row md:items-end md:justify-between">
          ...
          <Link to="/products" className="text-xs font-medium text-terracotta-600 hover:text-terracotta-500">
